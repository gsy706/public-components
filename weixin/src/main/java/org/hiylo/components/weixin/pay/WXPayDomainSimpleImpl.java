 ...
 * Project: components
 * File: WXPayDomainSimpleImpl.java
 * Data: 18-4-25 下午2:04
 * Author: hiylo
 *
 *
...
public class WXPayDomainSimpleImpl implements IWXPayDomain {
    ...
    @Override
    public synchronized DomainInfo getDomain(final com.github.wxpay.sdk.WXPayConfig config) {
    ...
    public String toString() {
        return "WXPayDomainSimpleImpl{" +
                "MIN_SWITCH_PRIMARY_MSEC=" + MIN_SWITCH_PRIMARY_MSEC +
                ", switchToAlternateDomainTime=" + switchToAlternateDomainTime +
