 ...
 * Project: framework
 * File: NoAuthenticationException.java
 ...
 */
public class NoAuthenticationException extends BaseException implements Serializable {
    private static final long serialVersionUID = 2560758391939000337L;

    public NoAuthenticationException(String code, String message) {
        super(code, message);
    }
}